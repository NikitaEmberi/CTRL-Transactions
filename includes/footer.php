...
<center>
    <div class="container">
		Copyright <span class="glyphicon glyphicon-copyright-mark"></span> Ct<span class="fa fa-inr"></span>l Transactions
                All Rights Reserved |
        <a target="_blank" class="btn btn-social-icon btn-github" href="https://github.com/NikitaEmberi"><i class="fa fa-github"></i></a>
